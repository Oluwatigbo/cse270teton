...
class TestSmokeTest():
  ...
  def test_adminpagetest(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(970, 1085)
    ...
    self.driver.find_element(By.ID, "password").send_keys("login")
  ...
  def test_joinpagetest(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Morgan")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Rodgers")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Mr ltd")
